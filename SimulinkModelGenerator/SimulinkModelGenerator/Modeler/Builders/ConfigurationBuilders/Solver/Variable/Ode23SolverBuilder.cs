...
namespace SimulinkModelGenerator.Modeler.Builders.ConfigurationBuilders.Solver.Variable
{
    public sealed class Ode23SolverBuilder : IOde23VariableSolverType
    {
        ...
        {
            model.ConfigSet.Solver.SolverOptions.Solver = VariableSolver.Ode23.GetDescription();
            model.ConfigSet.Solver.SolverOptions.SolverName = VariableSolver.Ode23.GetDescription();
