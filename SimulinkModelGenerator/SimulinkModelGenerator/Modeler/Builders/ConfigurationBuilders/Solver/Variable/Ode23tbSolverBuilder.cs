...
namespace SimulinkModelGenerator.Modeler.Builders.ConfigurationBuilders.Solver.Variable
{
    public sealed class Ode23tbSolverBuilder : IOde23tbVariableSolverType
    {
        ...
        {
            model.ConfigSet.Solver.SolverOptions.Solver = VariableSolver.Ode23tb.GetDescription();
            model.ConfigSet.Solver.SolverOptions.SolverName = VariableSolver.Ode23tb.GetDescription();
